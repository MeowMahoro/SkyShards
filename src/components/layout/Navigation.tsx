...
import { Calculator, Settings, Shuffle, Share2, Menu, X, ExternalLink, TrendingUp } from "lucide-react";
...
export const Navigation: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: "/arbitrage", label: "Arbitrage", icon: TrendingUp, color: "amber" },
  ];
              ...
              {navItems.map(({ path, label, icon: Icon, color }) => {
                ...
                const ringClass = isActive
                  ? color === "blue"
                    ...
                    ? "ring-1 ring-offset-0 ring-yellow-300"
                    : color === "amber"
                    ? "ring-1 ring-offset-0 ring-amber-300"
                    : "ring-1 ring-offset-0 ring-purple-300"
                  : "";
                return (
                  <Link
